...
/obj/item/bloodcult_pamphlet/attack_self(mob/user, modifiers)
	if (IS_CULTIST(user))
		return
...
/obj/item/bloodcult_pamphlet/oneuse/attack_self(mob/user, modifiers)
	..()
	qdel(src)

/obj/item/bloodcult_pamphlet/salt_act()
	fire_act(1000, 200)
