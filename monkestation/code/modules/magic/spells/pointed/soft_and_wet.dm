...
/datum/action/cooldown/spell/pointed/soft_and_wet/New(Target)
	...
	attunements[MAGIC_ELEMENT_WATER] += wet_attunement_amount
...
/datum/action/cooldown/spell/pointed/soft_and_wet/proc/get_mana_consumed()
...
/datum/action/cooldown/spell/pointed/soft_and_wet/is_valid_target(atom/cast_on)
	...
	if(isopenturf(castturf))
		src.cast_on = castturf
