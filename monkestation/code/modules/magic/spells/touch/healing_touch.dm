...
/datum/action/cooldown/spell/touch/healing_touch/New(Target, original)
	...
	attunements[MAGIC_ELEMENT_LIFE] = healing_touch_attunement_amount
...
/datum/action/cooldown/spell/touch/healing_touch/proc/get_mana_consumed()
	return (brute_heal + burn_heal + tox_heal + oxy_heal) \
...
/datum/action/cooldown/spell/touch/healing_touch/cast_on_hand_hit(obj/item/melee/touch_attack/hand, mob/living/victim, mob/living/carbon/caster)
	...
	if(victim.health == starting_health)
		return FALSE
